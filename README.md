...
<div>
 ...
 <div style="display: inline_block"><br>
  ...
  <img src="https://skillicons.dev/icons?i=git,vscode,c#,.net,javascript,typescript,css,html,angular,react,next,tailwind,sass,nodejs,express,nest,docker,github,jest,materialui,linux,postman,styledcomponents,vercel,bootstrap,mongodb,postgres,discord,linkedin,instagram" />
</a>
